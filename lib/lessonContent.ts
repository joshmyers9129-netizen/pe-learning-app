  ...
  // ── Day 2 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      // ── Source note ───────────────────────────────────────────────────────
      {
        ...
        title: "Sources for this lesson",
        content:
          "Fee structure and economic terms: ILPA Principles 3.0, Section 4 (economic terms, fee offsets, clawback), ilpa.org/principles. GP catch-up mechanics and waterfall sequencing: CAIA Association Level II, private equity fund terms chapters. Management fee step-down and fee offset practices: ILPA Fee Reporting Template and Fee Transparency Initiative (2016–2022 editions). Preferred return conventions and market data: Preqin Global Private Equity Report (annual); fund term surveys reporting median hurdle rates, carry rates, and GP commitment levels. Clawback enforceability and escrow practices: ILPA Principles 3.0, Section 4 calls for clawback provisions with escrowed reserves; escrow levels of 25–30% of carry distributions reflect market convention documented in ILPA educational materials and American Bar Association Private Equity and Venture Capital Committee resources. GP commitment convention (1–3% of fund): ILPA Principles 3.0 recommends GP commitment of 'at least' 1% as a minimum alignment signal; Preqin GP Survey data shows median GP commitment for established buyout managers at 2–3% of fund; Preqin Global Private Equity Report (annual). GP commitment financing via carry loans: acknowledged in ILPA educational materials on fee transparency; specific carry-loan program prevalence reflected in LP survey data from ILPA's Institutional LP Survey. CFA Institute: Private Markets and Alternative Investments curriculum, carried interest calculation methodology.",
      },
      // ── Weak vs. strong answer ────────────────────────────────────────────
      {
        type: "weak-answer",
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          ...
          "$360M — approximately 8% compounded for 7 years on $500M ($500M × (1.08⁷ − 1) ≈ $357M)",
  ...
  // ── Day 3 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      // ── Worked example ────────────────────────────────────────────────────
      {
        ...
        content:
          "Fund V: $1.5B committed, 2%/20% structure, 8% preferred return, 5-year investment period. Management fee: $30M/year during investment period on committed capital. Year 1: $300M called ($30M fees + $270M invested, 3 platforms). NAV: ~$270M (portfolio marked at cost; no appreciation yet). Distributions: $0. Net IRR: −11% (fee drag: $30M paid before any gain; LP has paid in $300M and owns $270M of value). Year 2: Additional $400M called ($30M fees + $370M deployed, 3 more platforms). Total called: $700M. Total fees paid: $60M. Total invested: $640M. NAV: $650M (portfolio broadly at cost with modest early marks on 2 year-1 platforms; NAV is below total called because $60M in fees has left the fund permanently). DPI: $0. Net IRR: −6% (IRR on {−$300M, −$400M, terminal $650M} over 2 years, verified: NPV ≈ 0 at r = −6%). Year 3: Additional $350M called ($30M fees + $320M follow-ons/new platform). Total called: $1.05B. Total fees: $90M. NAV: $1.0B (2 companies with meaningful EBITDA growth partially offset by fee drag; portfolio sits just below cost of total paid-in capital). DPI: $0. Net IRR: −1% (IRR on {−$300M, −$400M, −$350M, terminal $1.0B} over 3 years, verified: NPV ≈ 0 at r ≈ −1%). Year 4 (inflection): First exit — Company A sold for $420M equity (invested $160M equity, 2.6x gross). Distribution: $420M. Additional $150M called. Total called: $1.2B. Post-exit NAV: $1.1B (remaining 8 companies; Company A removed at $160M cost basis, remaining portfolio appreciated and augmented by $120M new follow-on investments). DPI: 0.35x ($420M / $1.2B). Net IRR: +9% — the inflection arrives with the first real exit; one strong exit shifts IRR by ~10 points. Year 5: Investment period closes. Two more exits. Total called: $1.45B. DPI: 0.65x. TVPI: 1.42x. Net IRR: 11%. Year 7 (harvest peak): Five of nine companies exited. DPI: 1.25x. TVPI: 1.72x. Net IRR: 16%. Year 9 (near wind-down): All but two companies exited. DPI: 1.65x. TVPI: 1.82x. Net IRR: 17.5%. Subscription line comparison: if Fund V used a 180-day subscription line for all calls, reported year-3 IRR might read +2% instead of −1% — a 3-point improvement from pure mechanics. Same deals, same exits, different reported curve. An LP comparing Fund V (with subscription line) to a peer fund (without) on year-3 IRR will draw a misleading conclusion about relative quality.",
      },
      {
        type: "teaching",
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          "An over-commitment ratio below 1.2x eliminates simultaneous call risk, so a well-managed PE program does not require a separate liquidity buffer",
          "GPs coordinate capital call timing across vintages to avoid simultaneous demand, so individual LP pacing models are only needed for programs with more than ten active funds",
          "The correct LP policy is a formal pacing model with a liquidity buffer explicitly sized against peak simultaneous call scenarios — 'plenty of cash' is not a substitute for a structured projection against contractual obligations",
          "Simultaneous calls totaling $90M on $600M uncalled are within the normal operating range; the real risk only arises when total simultaneous calls exceed 25% of uncalled commitments",
        ],
        correctAnswer:
          "The correct LP policy is a formal pacing model with a liquidity buffer explicitly sized against peak simultaneous call scenarios — 'plenty of cash' is not a substitute for a structured projection against contractual obligations",
      },
