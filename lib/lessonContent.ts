...
export const lessonContents: LessonContent[] = [
  ...
  // ── Day 6 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        content:
          "A mid-market buyout GP presents three consecutive funds at a fundraising meeting for Fund V. Here is the data on the table:\n\n| | Fund III | Fund IV | Fund V |\n|---|---|---|---|\n| Vintage | 2013 | 2017 | 2021 |\n| Current fund age | Year 10 | Year 6 | Year 3 |\n| Fund size | $1.8B | $2.2B | $2.8B |\n| Net IRR | 18.4% | 14.2% | 4.8% |\n| Net TVPI | 2.18x | 1.72x | 1.12x |\n| DPI | 1.95x | 0.65x | 0.04x |\n| RVPI | 0.23x | 1.07x | 1.08x |\n\n**Fund III (year 10, late harvest/wind-down):**\nDPI of 1.95x means 195 cents per LP dollar has been confirmed in actual distributions. RVPI of 0.23x is residual — likely one or two remaining companies near exit. Net IRR of 18.4% is close to final. This is confirmed, realized performance. A 2013-vintage mid-market buyout at 18.4% net IRR / 2.18x net TVPI is strong — the Cambridge Associates 2013-vintage mid-market buyout top-quartile threshold at final close is approximately 18–20% net IRR and 2.0–2.3x net TVPI; the median sits at approximately 13–15% net IRR. Fund III's 18.4% / 2.18x places it at the top-quartile boundary — confirmed by near-final DPI of 1.95x. **Conclusion: real, verifiable track record. This is the most analytically useful information in the room.**\n\n**Fund IV (year 6, harvest phase):**\nDPI of 0.65x means only 65 cents confirmed in cash; RVPI of 1.07x is GP-marked unrealized value. The IRR of 14.2% is meaningful but not final — approximately two-thirds of the portfolio by value remains to be exited. For context, the Cambridge 2017-vintage mid-market buyout median at year 6 is approximately 12–14% net IRR — Fund IV's 14.2% is near the top of the median range, not yet clearly top-quartile. Quartile rankings shift materially as exits occur and DPI builds; a fund at 0.65x DPI in year 6 is being compared to peers that may have higher DPI and therefore more confirmed returns in the same benchmark. Key questions: are the remaining portfolio company marks realistic? How concentrated is the RVPI? **Conclusion: encouraging trajectory, but roughly half the eventual story is still written in pencil — and the benchmark comparison is provisional.**\n\n**Fund V (year 3, investment period):**\nDPI of 0.04x is essentially zero. RVPI of 1.08x is entirely GP-marked. The 4.8% net IRR reflects early J-curve mechanics: fee drag partially offset by initial mark-ups. This is structurally expected for a well-run buyout fund in year 3. **What to ask about Fund V is not its IRR — it is deployment pace against the IP close date, portfolio construction (how many platforms, sector concentration), and the first expected exit timeline. Cambridge Associates does not publish reliable vintage-year quartile boundaries until a cohort has reached year 4–5 with meaningful DPI; no valid benchmark comparison exists for a 2021-vintage fund at year 3.**\n\n**The comparison trap:**\nThe GP presents all three on the same slide and implies consistent outperformance. Fund III is near-final; Fund IV is a meaningfully uncertain interim; Fund V is essentially unmeasurable. Correct response: 'We can draw confident conclusions about Fund III. For Fund IV, we'd like to understand how the remaining RVPI is distributed across portfolio companies and the exit pipeline timeline. For Fund V, it's too early to evaluate on IRR — walk us through deployment pace and portfolio construction instead.'",
      },
      {
        type: "source-note",
        title: "Sources for this lesson",
  ...
  // ── Day 7 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        content:
          "The LBO capital structure defines the return mechanics before a single operational decision is made. Understanding it allows you to evaluate whether a GP's historical returns were supported by a favorable debt environment — and what a tightening credit market does to their model.\n\n**Typical LBO capital structure — post-2015 large buyout environment:**\n\n| Layer | Typical Size | Approximate Cost | Seniority | Characteristics |\n|---|---|---|---|---|\n| Senior secured (first-lien TL/revolver) | 4–5x EBITDA | SOFR + 3.5–5.0% | 1st lien on assets | Largest piece; institutional loan market; covenant-lite common |\n| Second-lien / unitranche | 0.5–1.0x EBITDA | Higher spread | 2nd lien | Prevalent in mid-market; combines senior and junior in one |\n| High-yield bonds (large deals) | 1–2x EBITDA | 6–9% fixed | Junior unsecured | Larger transactions; less common post-2022 |\n| GP / co-investor equity | 40–55% of EV | N/A | Residual | Lowest priority; highest upside; bear total leverage risk |\n\n**Total leverage at entry:** Typically 5–7x EBITDA in the 2012–2021 environment; peaked at 7–8x in 2021; compressed to 5–6x in 2023 as credit markets tightened. Leverage multiples are the single most credit-cycle-sensitive variable in LBO economics.\n\n**How leverage amplifies equity returns — the formal expression:**\n\nDay 1's Company A example showed the basic principle: leverage at 50% equity fraction amplified a 30% EV gain into a 120% equity return. The general expression is:\n\n**Equity return amplification multiple = 1 / (equity fraction of EV)**\n\n- At 50% equity (50% LTV) → 2.0× amplification: a 25% EV gain produces a 50% equity return; a 25% EV loss produces a 50% equity loss\n- At 40% equity (60% LTV) → 2.5× amplification: a 25% EV gain produces a 62.5% equity return; the same EV loss produces a 62.5% equity loss\n\nAmplification is symmetric — it doubles both gains and losses equally. This mechanical property is why entry leverage ratio is one of the two most intensely scrutinized variables in any buyout diligence — alongside entry EV/EBITDA multiple.",
      },
      {
        type: "visual",
        title: "IRR vs. MOIC: How the Three Return Drivers Affect Each Metric Differently",
        visualId: "irr-vs-moic",
        caption:
          "The three LBO return drivers — EBITDA growth, multiple expansion, and debt paydown — do not affect IRR and MOIC identically. EBITDA growth and multiple expansion each raise enterprise value at exit, improving both MOIC and IRR. Debt paydown improves MOIC directly (by reducing the debt claim against exit EV) without necessarily accelerating exit timing. Understanding the different signature of each driver in both metrics is the foundation of a rigorous value bridge analysis.",
        whyItMatters:
          "A GP who shows strong IRR on an early exit and strong MOIC on a longer hold is not achieving the same outcome — the LP is wealthier under the MOIC scenario. When you receive a GP's track record, note whether they quote IRR or MOIC as the headline: IRR is the fundraising metric (time-sensitive, easily inflated by early exits); MOIC is the LP wealth metric (insensitive to timing, reflects actual capital multiplication). A fund with EBITDA-driven returns will have consistent MOICs across different hold periods; a fund with timing-driven IRR will show MOIC declining as hold periods extend. Day 10 covers the exit timing trade-off in full — this visual provides the interpretive framework for both lessons.",
        sourceNote:
          "IRR vs. MOIC mechanics and three-driver interaction: CFA Institute, Private Markets and Alternative Investments curriculum; CAIA Level II, private equity return measurement chapters.",
      },
      {
        type: "teaching",
  ...
  // ── Day 8 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        content:
          "**Buyout:**\n- **Target:** Mature, cash-generative businesses with stable free cash flow sufficient to service acquisition debt (predictable EBITDA, defensible market position, limited reinvestment requirements)\n- **Stake and control:** Controlling (typically 60–100%); GP has full board authority and management replacement rights\n- **Leverage:** 4–6x EBITDA at acquisition; central to the return model and the primary source of amplification\n- **Return drivers:** Three-driver model — EBITDA growth + multiple expansion + debt paydown (Day 7 for full mechanics)\n- **Hold period:** 3–7 years\n- **Key structural risk:** Credit market conditions at entry constrain leverage availability and entry multiples; most credit-cycle-sensitive PE strategy — a tightening credit environment reduces the leverage amplification that defines the model\n\n**Growth Equity:**\n- **Target:** Profitable or near-profitable companies with proven business models that need capital to scale (geographic expansion, sales force build-out, bolt-on acquisitions)\n- **Stake and control:** Minority (typically 20–40%); GP influence through board representation and governance, not operational control\n- **Leverage:** None or minimal; investment funded from the company's balance sheet, not acquisition debt\n- **Return drivers:** Revenue and earnings growth (primary); multiple expansion if the company achieves premium public-market comparable status at exit (secondary)\n- **Hold period:** 3–5 years\n- **Key structural risk:** Returns are sensitive to revenue multiples in exit markets (technology, healthcare SaaS); public comparable valuations at exit directly affect realized returns — as the 2021–2022 SaaS multiple contraction demonstrated\n\n**Venture Capital:**\n- **Target:** Early-stage companies with unproven or partially-proven models — pre-revenue, pre-profitability, sometimes pre-product\n- **Stake and control:** Minority (10–25% per round); GP has information rights and board representation, not operational control\n- **Leverage:** None; pre-revenue companies cannot service debt\n- **Return drivers:** Revenue and earnings growth of the rare winners (10–50x returns from 2–4 breakout investments per fund); the 40–60%+ deal-level loss rate is expected and modeled in advance — the fund economics only work if the outliers are large enough\n- **Hold period:** 7–12+ years from first investment to liquidity\n- **Key structural risk:** Return distribution is extreme — most deals lose money, most funds underperform the median, but top-quartile funds generate 3–5x+ MOICs from outlier concentration; the strategy generates LP-positive risk-adjusted returns only with top-tier manager access",
      },
      {
        type: "teaching",
      ...
      {
        type: "visual",
        title: "The Buyout J-Curve: Reference Baseline for Cross-Strategy Comparison",
        visualId: "j-curve",
        caption:
          "This curve shows a representative buyout fund J-curve: trough near year 2 (fee drag before exits), inflection near year 5 (first exits offset early-period losses), positive IRR through harvest phase. Use it as a baseline. Growth equity's trough is shallower (approximately −6 to −8% vs. −12%) and its inflection arrives earlier (year 3–4, because there is no debt service drag and hold periods are shorter). Venture capital's trough is deeper (−15 to −20%+ is structurally normal) and its inflection arrives later (year 6–8+, because companies require multiple financing rounds before any exit liquidity).",
        whyItMatters:
          "Benchmarking a year-3 VC fund against this buyout curve produces a false negative: a year-3 VC fund at −15% net IRR is performing exactly as a healthy VC J-curve predicts — not underperforming. A year-3 buyout fund at −5% is also structurally expected. Neither is a performance signal; both are mechanical outputs of their respective cost structures and exit timing profiles. The comparison mistake is using the buyout timeline to judge strategies with fundamentally different J-curve geometries.",
        sourceNote:
  ...
  // ── Day 9 ──────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      {
        type: "teaching",
        title: "The four forms of EBITDA growth — repeatability and what each implies about GP skill",
        content:
          "Not all EBITDA growth is equal. The four primary sources produce materially different implications for GP skill assessment and forward repeatability:\n\n| Form | Mechanism | Repeatability | GP Skill Signal |\n|---|---|---|---|\n| **Organic revenue growth** | Volume expansion or new customer acquisition in the underlying business | High — reflects competitive positioning | Strongest; consistent organic growth across diverse sectors indicates GP company-selection and positioning capability |\n| **Pricing improvement** | Same volume, higher revenue per unit; requires pricing power (brand, moat, or switching costs) | Highest — pricing power is a structural asset that persists post-exit | Most transferable; a data-driven pricing methodology is a genuine, replicable playbook |\n| **Margin improvement via cost reduction** | Fixed cost reduction, procurement leverage, headcount rationalization, facilities consolidation | Low — a one-time lever; a portfolio company that cut 400bps of margin in year 1 cannot repeat the same cut in year 2 | Useful but limited; often overstated as a 'playbook'; does not grow the business |\n| **Acquisition-driven EBITDA (buy-and-build)** | Bolt-on acquisitions add EBITDA mechanically, inflating the portfolio-level growth headline | Conditional — depends on acquisition economics vs. exit multiple; not organic improvement | Ambiguous; requires decomposition (see worked example) |\n\n**The decomposition question that changes everything:**\nA platform that grew from $30M to $80M EBITDA while making three bolt-ons at an average of $15M EBITDA each has organic EBITDA growth of approximately $80M − $30M − $45M = **$5M** — far less impressive than the headline 167% growth suggests. Always ask explicitly: *'What is your EBITDA organic growth rate, controlling for bolt-on acquisitions?'*",
      },
      {
        type: "teaching",
      ...
      {
        type: "visual",
        title: "IRR vs. MOIC: What the Return Metric Mix Reveals About Value Creation Quality",
        visualId: "irr-vs-moic",
        caption:
          "EBITDA growth compounds into MOIC — the longer the company is held at growing EBITDA, the higher the terminal multiple on invested capital. A GP with genuine operational improvement capability should show MOICs that grow with hold period, not IRR that shrinks. A GP who optimizes for IRR through early exits may show a 22% IRR with a 2.0x MOIC — and a different GP who held companies longer may show 18% IRR with a 2.6x MOIC. The LP is wealthier under the second scenario despite the lower IRR headline.",
        whyItMatters:
          "When auditing a GP's value creation claim, check whether the IRR and MOIC tell a consistent story. High IRR with modest MOIC means short hold periods — not necessarily strong operations. High MOIC with moderate IRR means long holds with sustained value creation — the pattern that most strongly supports the 'operational improvement platform' narrative. If a GP claims 90% EBITDA growth drove returns but shows a 1.9x net MOIC on a 6-year fund, the math suggests exits came early or the EBITDA growth was not fully captured in terminal value. Day 10 covers exit timing trade-offs in full; this visual provides the return-metric lens for the portfolio-level audit in this lesson.",
        sourceNote:
          "IRR/MOIC relationship and value creation assessment: CFA Institute, Private Markets and Alternative Investments curriculum; CAIA Level II, private equity performance measurement.",
      },
      {
        type: "example",
  ...
  // ── Day 10 ─────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      {
        type: "visual",
        title: "IRR vs. MOIC: The Exit Timing Trade-Off",
        visualId: "irr-vs-moic",
        caption:
          "The table above (year-4 exit at 2.8x / 24% IRR vs. year-6 exit at 3.4x / 19% IRR) is the arithmetic this visual illustrates. Holding two additional years grows the LP's terminal wealth by 0.6x MOIC but costs approximately 5 IRR points. Whether to exit now or hold depends on: (1) the LP's reinvestment rate on returned capital; (2) whether the incremental value creation at the company outperforms the LP's next-best use of funds; and (3) what incentives the GP faces — specifically whether fundraising timing creates a carry-motivated bias toward early exits.",
        whyItMatters:
          "Reading a GP's historical exit timing pattern against this trade-off reveals which metric they are optimizing. A GP who consistently exits companies in years 4–5 — even when growth trajectories are intact — is likely IRR-motivated, possibly because strong IRR is the primary fundraising narrative. A GP who holds companies to years 6–8 may show lower IRR but generates more absolute LP wealth. Neither is universally correct; it depends on the LP's reinvestment rate and time preference. The pattern should be explicit and aligned with LP objectives — and any systematic early-exit tendency should be raised in the LPAC if it appears correlated with fundraising cycles.",
        sourceNote:
          "IRR/MOIC exit timing trade-off and GP incentive alignment: CFA Institute, Private Markets and Alternative Investments curriculum; CAIA Level II, private equity return measurement; ILPA Principles 3.0, Section 5 (conflict of interest disclosure).",
      },
      {
        type: "visual",
