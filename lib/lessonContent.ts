...
export const lessonContents: LessonContent[] = [
  ...
  // ── Day 11 ─────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      {
        type: "teaching",
        title: "Building on Day 2: what this lesson adds",
        content:
          "Day 2 covered the core four-tier waterfall — return of capital, preferred return, catch-up, and carried interest split — with a full $1B fund worked example including catch-up arithmetic and the clawback concept. This lesson does not repeat that foundation.\n\nWhat this lesson adds that Day 2 does not cover:\n- **The American vs. European distinction** — the same fund, same deals, different carry timing and LP risk profile\n- **A numerical side-by-side** showing how carry recognized in an American waterfall creates a clawback obligation when later exits underperform\n- **Recycling, term, and extension mechanics** — provisions that interact with the waterfall to shape effective LP exposure and fund duration\n- **The full alignment package** — how to read economic and governance terms together, not in isolation\n\nIf you want to review the four-tier waterfall sequence or the $1B catch-up calculation before continuing, return to Day 2.",
      },
      {
        type: "visual",
      ...
      {
        type: "teaching",
        title: "Term and extension rights: the mechanics that matter",
        content:
          "**Fund term and extension rights:** Most PE funds have a 10-year base term, with one or two one-year extensions available. Extensions are common — realizations often take longer than planned, and forcing exits in a compressed window can destroy value. However, extension rights deserve analysis:\n\n- **Who controls the right?** Extensions exercisable at GP sole discretion are substantially different from those requiring LPAC approval or LP majority consent. The difference is LP oversight vs. none.\n- **What is the trigger?** Extensions to maximize value on specific remaining assets are more defensible than open-ended extensions that simply extend both the hold period and the fee period.\n- **Fee treatment during extension:** Some LPAs allow management fees to continue at full rate during extensions. ILPA best practice: step down to invested-capital basis or a reduced rate. At $2B fund scale, a full-fee extension year costs LPs roughly $20–30M in additional management fees above what the investment period warrants.\n- **Extension stacking:** Two one-year extensions at GP discretion effectively extends the fund to 12 years without LP input. Ask: have prior funds used extensions? On what basis? Was LPAC consulted even where not contractually required?\n\n**Other governance terms:** Key-person provisions, no-fault removal, LPAC authority, and side-letter MFN treatment are covered in detail in Day 19 (GP Governance and Ongoing LP Oversight). The focus here is on how extension and fee provisions interact specifically with LP economics — the waterfall and alignment picture.",
      },
      {
        type: "teaching",
      ...
      },
      {
        ...
        content:
          "**Six dimensions of fund alignment — strong vs. weak LP signal:**\n\n- **Fee basis**\n  - Strong: Steps down to invested capital post-investment period; 100% portfolio company fee offset\n  - Weak: Committed capital basis throughout; 80% or lower offset rate\n\n- **Carry timing**\n  - Strong: European (whole-fund) waterfall; carry deferred until aggregate LP hurdles cleared\n  - Weak: American deal-by-deal; GP can receive carry on early winners before full-fund outcomes known\n\n- **Clawback protection**\n  - Strong: Escrow held by third party (25–30% of carry); clear calculation methodology and defined enforcement\n  - Weak: Contractual obligation only; no escrow; no personal guarantee; practical recovery uncertain\n\n- **GP commitment**\n  - Strong: 3%+ of fund size; capital at risk alongside LPs\n  - Weak: Less than 1% of fund; token amount relative to anticipated carry economics\n\n- **Recycling**\n  - Strong: Narrow authority (dividends or specific categories only); historical use disclosed and consistent with stated authority\n  - Weak: Broad GP discretion over any proceeds within a multi-year window; vague historical disclosure\n\n- **Extension rights**\n  - Strong: Extensions require LPAC approval or LP majority consent; fee steps down during extension\n  - Weak: GP sole discretion; no fee reduction; extensions extend both hold period and fee period without LP oversight",
        whyItMatters:
          "Fund alignment is not a binary. A fund can be 'market' on every individual dimension and still present a package that disproportionately favors GP flexibility over LP protection. Evaluate the six dimensions together — a single weak-signal dimension may be acceptable; multiple weak signals in combination are a material concern.",
        sourceNote:
          "ILPA Principles 3.0 (Section 4: Economic Terms) — alignment best practices and model LPA provisions; CFA Institute alternative investments curriculum.",
      },
      {
        type: "example",
        title: "Worked example: American vs. European waterfall — side-by-side calculation",
        content:
          "**Scenario:** A $200M fund makes two equal investments of $100M each. Terms: 8% preferred return (compounded annually), 20% carry, 100% catch-up. Same GP, same deals — the only variable is waterfall structure.\n\n- **Deal A:** Cost $100M. Proceeds $250M at Year 4. Profit: $150M. Preferred on $100M × 4 years @ 8% compounded: $36M.\n- **Deal B:** Cost $100M. Proceeds $20M at Year 8. Loss: ($80M).\n- **Net fund profit above capital:** $150M − $80M = $70M.\n\n---\n\n**American waterfall (deal-by-deal) — Deal A processed at Year 4 independently:**\n\n1. Return Deal A capital: $100M → LP\n2. Preferred return ($100M × 4 yrs @ 8% compounded): $36M → LP\n3. Remaining profit above preferred: $150M − $36M = $114M\n4. Catch-up (100%): GP receives until GP = 20% of ($36M preferred + catch-up). Formula: C = preferred / 4 = $36M / 4 = $9M → GP\n5. Remaining: $114M − $9M = $105M → split 80/20 → LP $84M, GP $21M\n\n**GP carry from Deal A: $9M + $21M = $30M (= 20% × $150M ✓)**\n**LP from Deal A: $100M + $36M + $84M = $220M**\n\nDeal B at Year 8: $20M proceeds, $80M loss. LP receives $20M partial capital return. GP: $0.\n\n**American summary:**\n- LP received: $220M + $20M = $240M\n- GP carry received: $30M\n- GP earned $30M carry on Deal A regardless of Deal B's $80M capital loss.\n\n---\n\n**European waterfall (whole-fund) — all proceeds aggregated at final wind-down:**\n\nTotal proceeds: $250M + $20M = $270M. Total LP capital: $200M.\nFull-fund preferred (Deal A: $36M × 4 yrs; Deal B: $100M × 8 yrs @ 8% ≈ $85M): $121M total preferred.\n\n1. Return all LP capital: $200M → LP. Remaining: $70M.\n2. Preferred return due: $121M. Available: $70M. Full preferred not covered → $70M → LP (partial preferred). Remaining: $0.\n3. Catch-up tier: not reached. GP carry: $0.\n\n**European summary:**\n- LP received: $200M + $70M = $270M\n- GP carry: $0\n\n---\n\n**What this shows:**\n- American GP carry: **$30M** vs. European GP carry: **$0** — same fund, same two deals.\n- Under American waterfall, the GP earned $30M carry on Deal A's isolated profit even though Deal B destroyed $80M of capital and total fund economics produced no carry entitlement.\n- Under European waterfall, Deal B's loss consumed the profit pool entirely — the LP preferred return is not even fully covered, so no carry tier is reached.\n\n**Clawback calculation under American waterfall:**\nGP received $30M at Year 4. Whole-fund carry entitlement: $0 (no net profit above capital + preferred). Clawback obligation: $30M — the full amount received.\n\nIf that $30M was paid to individual GP partners who have since spent, invested, or paid taxes on it, recovery requires enforcement against individuals rather than a fund account. Without escrow, the LP holds a contractual right against potentially illiquid counterparties.",
      },
      {
        type: "weak-answer",
  ...
  // ── Day 12 ─────────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        content:
          "**A credible PE performance assessment uses all four tools:**\n\n- **Peer quartile ranking**\n  - Primary question: How did the fund perform vs. PE peers in the same vintage and strategy?\n  - Key limitation: Does not compare to public alternatives; affected by survivor bias and peer-set composition\n\n- **Vintage-year comparison**\n  - Primary question: How does fund performance look in context of its macro and market environment?\n  - Key limitation: Does not isolate skill from vintage tailwind/headwind; definition of vintage year varies by data provider\n\n- **PME (public market equivalent)**\n  - Primary question: Did the fund outperform a liquid public-market alternative given the same cash-flow timing?\n  - Key limitation: Depends on benchmark choice; does not address leverage, valuation quality, or risk differences\n\n- **Realized vs. unrealized split**\n  - Primary question: How much of the reported return is confirmed cash vs. GP-estimated marks?\n  - Key limitation: Does not verify whether remaining marks are accurate; requires deal-level investigation",
        whyItMatters:
      ...
      {
        type: "teaching",
        title: "PME: pointer to Day 4 and what this lesson adds",
        content:
          "Day 4 covers KS-PME mechanics in full — the cash flow timing logic, the numerator/denominator construction, and the subscription-line inflation effect on IRR. This lesson does not repeat that derivation. Instead, it focuses on two things Day 4 does not cover:\n1. **How to select among KS-PME, mPME, and Direct Alpha** — when each variant is appropriate and why the choice matters\n2. **How PME fits into a complete benchmarking toolkit** alongside peer quartiles, vintage-year comparisons, and realized vs. unrealized quality checks\n\nBrief orienting summary for continuity: PME asks whether PE outperformed a public-index alternative given the same cash flow timing. A KS-PME of 1.0 means parity with the index; 1.15 means 15% more total value created. PME is more rigorous than peer quartiles for the core opportunity-cost question — but it is not a complete answer, for two reasons a prepared allocator always flags:\n- **Benchmark selection matters.** PME vs. S&P 500 vs. Russell 2000 vs. MSCI World will give different results for the same fund. The benchmark should reflect the fund's actual risk exposure.\n- **NAV quality is not verified.** PME uses reported NAV as the terminal value. An inflated NAV inflates the PME. Always check the realized vs. unrealized mix before accepting a PME result at face value.",
      },
      {
        type: "teaching",
        title: "KS-PME vs. mPME vs. Direct Alpha: when to use which",
        content:
          "Three PME variants dominate practice. The right choice depends on what you are trying to measure and the fund's distribution pattern.\n\n**KS-PME (Kaplan-Schoar, 2005)**\n- Grows all capital calls at the index and nets distributions as they are paid; residual public index position is the denominator\n- Limitation: In high-distribution scenarios, the public market position can theoretically go negative (if distributions exceed the grown index position). This produces a nonsensical denominator.\n- Use when: The fund has modest distributions relative to its NAV, or you are doing a preliminary comparison across a large sample of funds.\n\n**mPME (Modified PME, Long-Nickels variant)**\n- Scales distributions so the public market position never goes negative; uses a pro-rata distribution approach\n- Advantage: Avoids the sign problem; more mathematically robust for funds with large early distributions\n- Limitation: The scaling adjustment makes the numerator harder to interpret intuitively\n- Use when: The fund has made substantial distributions early relative to the public index position — common in buyout funds with quick exits\n\n**Direct Alpha (Gredil, Griffiths, Stücke)**\n- Converts the PME comparison into an annualized alpha expressed in percentage points (e.g., +250 bps/year above the index)\n- Advantage: Intuitive — communicates outperformance in a format familiar from public markets; additive across time periods\n- Limitation: Requires a risk-free rate assumption; slightly more inputs than KS-PME\n- Use when: Communicating results to investment committees, trustees, or boards who are fluent in alpha language but unfamiliar with PME ratios; also preferred for comparing managers across different fund sizes and vintages\n\n**Practical selection rule:**\n- Default to KS-PME for screening and peer comparison across large datasets\n- Use mPME when distributions are heavy (DPI > 0.8x in the early years)\n- Use Direct Alpha when communicating to committees or comparing managers with different return profiles\n- When a GP presents only one PME variant, ask for the others — variant selection can move the apparent result meaningfully",
      },
      {
        type: "visual",
        title: "Vintage-year comparison: isolating macro from manager",
        content:
          "**Illustrative vintage-year effects on PE performance — buyout strategy:**\n\n- **2006–2007 vintage**\n  - Entry: High multiples (9–11x EV/EBITDA); leverage abundant pre-crisis\n  - Exit: Mixed — financial crisis disrupted many hold periods; recovery-era exits eventually helped some\n  - Typical result: Wide dispersion; median performance challenging; strong-quartile result required genuine skill\n\n- **2009–2011 vintage**\n  - Entry: Low multiples (6–8x); post-crisis pricing; leverage improving\n  - Exit: Strong — rising public market multiples through 2014–2018 created a vintage tailwind\n  - Typical result: Favorable for most managers; top-quartile result in this vintage requires less differentiation\n\n- **2014–2016 vintage**\n  - Entry: Moderate-high (8–10x); competitive market returning\n  - Exit: Generally good — pre-COVID conditions and sustained low rates supported exits\n  - Typical result: Reasonable; some multiple compression at exit vs. entry\n\n- **2019–2021 vintage**\n  - Entry: Elevated (10–13x); peak market pricing; aggressive leverage\n  - Exit: Challenged — rising rates post-2022, multiple compression, IPO market largely closed\n  - Typical result: Early results mixed; full outcomes pending; caution warranted on interim marks\n\nA top-quartile result in the 2006 vintage reflects more manager skill than the same rank in 2010 — the macro environment was dramatically more difficult. PME controls for this by comparing to the public-market alternative in the same period.",
        whyItMatters:
      ...
      },
      {
        ...
        content:
          "**When a GP presents a top-quartile result, ask these five questions before drawing conclusions:**\n\n- **What is the DPI?**\n  How much of the quartile result is confirmed cash vs. interim marks? A top-quartile fund with DPI 0.4x at year 7 has not yet confirmed the majority of its performance — the headline is provisional.\n\n- **What is the PME vs. a relevant public benchmark?**\n  Did the fund actually outperform the LP's liquid alternative on a cash-flow-adjusted basis? Quartile rank cannot answer this — it only compares PE to PE.\n\n- **What is the unrealized share of TVPI?**\n  If unrealized exceeds 60% of TVPI past year 6, the headline result is substantially dependent on GP-estimated Level 3 marks rather than market-confirmed values.\n\n- **What is the peer set composition?**\n  Are the peers genuinely comparable — same vintage year, same size range, same strategy focus? Or is the fund comparing favorably against a diluted or broad peer universe that inflates its apparent rank?\n\n- **What is the concentration of returns?**\n  Is the top-quartile result driven by broad portfolio performance or concentrated in one or two outlier deals? Concentration reduces the repeatability inference significantly — and may reflect a specific situation that cannot be replicated in the next fund.",
        whyItMatters:
      ...
      {
        type: "example",
        title: "Worked example: KS-PME step-by-step calculation",
        content:
          "**Scenario:** A fund makes three capital calls and two distributions. The public benchmark (assume S&P 500) returns 10% per year, compounded. Analysis date: end of Year 7. NAV at Year 7 = $0 (fully realized).\n\n**Cash flow schedule:**\n- Year 0: Call $100M\n- Year 2: Call $80M\n- Year 4: Call $70M\n- Year 5: Distribution $120M\n- Year 7: Distribution $300M\n\nTotal called: $250M. Total distributed: $420M. MOIC = 1.68x.\n\n---\n\n**Step 1: Grow each cash flow to the analysis date (Year 7) at the index return (10% p.a.)**\n\nCapital calls grown to Year 7:\n- $100M × 1.10^7 = $100M × 1.949 = **$194.9M**\n- $80M × 1.10^5 = $80M × 1.611 = **$128.9M**\n- $70M × 1.10^3 = $70M × 1.331 = **$93.2M**\n- **Total grown calls (denominator): $417.0M**\n\nDistributions grown to Year 7:\n- $120M × 1.10^2 = $120M × 1.210 = **$145.2M**\n- $300M × 1.10^0 = $300M × 1.000 = **$300.0M**\n- **Total grown distributions (numerator): $445.2M**\n\n---\n\n**Step 2: Compute KS-PME**\n\nKS-PME = Total grown distributions / Total grown calls = $445.2M / $417.0M = **1.068**\n\n---\n\n**Step 3: Interpret**\n- KS-PME of 1.068 means the PE fund created **6.8% more total value** than a passive index investment with the same cash flow timing.\n- The fund returned $420M on $250M called (MOIC 1.68x), but growing the same calls at 10% per year would have yielded $417M. The fund earned $28M more than the index alternative — modest outperformance.\n- If the PME were 0.95, the fund would have underperformed the index by 5% despite returning capital with a gain — a meaningful result that pure IRR or MOIC would not reveal.\n\n---\n\n**What to notice:**\n- The denominator grows calls forward at the index rate — this captures the opportunity cost of committing capital on those specific dates.\n- A later call ($70M at Year 4) has less time to compound, so it contributes less to the denominator than the same amount called at Year 0.\n- A distribution at Year 5 grows for two years (to Year 7) — early distributions have more time to accumulate index returns in the numerator.\n- NAV = 0 here (fully realized); for a live fund, add current NAV to the numerator as the residual PE position.",
      },
      {
        type: "example",
